...
admin: cosmos1..
decision_policy:
  '@type': /witvalchain.group.v1.ThresholdDecisionPolicy
  threshold: "1"
  windows:
...
```bash
simd tx group create-group-policy cosmos1.. 1 "AQ==" '{"@type":"/witvalchain.group.v1.ThresholdDecisionPolicy", "threshold":"1", "windows": {"voting_period": "120h", "min_execution_period": "0s"}}'
```
...
```bash
simd tx group create-group-with-policy cosmos1.. "AQ==" "AQ==" members.json '{"@type":"/witvalchain.group.v1.ThresholdDecisionPolicy", "threshold":"1", "windows": {"voting_period": "120h", "min_execution_period": "0s"}}'
```
...
```bash
simd tx group update-group-policy-decision-policy cosmos1.. cosmos1.. '{"@type":"/witvalchain.group.v1.ThresholdDecisionPolicy", "threshold":"2", "windows": {"voting_period": "120h", "min_execution_period": "0s"}}'
```
...
```bash
witvalchain.group.v1.Query/GroupInfo
```
...
```bash
grpcurl -plaintext \
    -d '{"group_id":1}' localhost:9090 witvalchain.group.v1.Query/GroupInfo
```
...
```bash
witvalchain.group.v1.Query/GroupPolicyInfo
```
...
```bash
grpcurl -plaintext \
    -d '{"address":"cosmos1.."}'  localhost:9090 witvalchain.group.v1.Query/GroupPolicyInfo
```
...
```bash
{
  "info": {
    ...
    "admin": "cosmos1..",
    "version": "1",
    "decisionPolicy": {"@type":"/witvalchain.group.v1.ThresholdDecisionPolicy","threshold":"1","windows": {"voting_period": "120h", "min_execution_period": "0s"}},
  }
}
```
...
```bash
witvalchain.group.v1.Query/GroupMembers
```
...
```bash
grpcurl -plaintext \
    -d '{"group_id":"1"}'  localhost:9090 witvalchain.group.v1.Query/GroupMembers
```
...
```bash
witvalchain.group.v1.Query/GroupsByAdmin
```
...
```bash
grpcurl -plaintext \
    -d '{"admin":"cosmos1.."}'  localhost:9090 witvalchain.group.v1.Query/GroupsByAdmin
```
...
```bash
witvalchain.group.v1.Query/GroupPoliciesByGroup
```
...
```bash
grpcurl -plaintext \
    -d '{"group_id":"1"}'  localhost:9090 witvalchain.group.v1.Query/GroupPoliciesByGroup
```
...
```bash
witvalchain.group.v1.Query/GroupPoliciesByAdmin
```
...
```bash
grpcurl -plaintext \
    -d '{"admin":"cosmos1.."}'  localhost:9090 witvalchain.group.v1.Query/GroupPoliciesByAdmin
```
...
```bash
witvalchain.group.v1.Query/Proposal
```
...
```bash
grpcurl -plaintext \
    -d '{"proposal_id":"1"}'  localhost:9090 witvalchain.group.v1.Query/Proposal
```
...
```bash
witvalchain.group.v1.Query/ProposalsByGroupPolicy
```
...
```bash
grpcurl -plaintext \
    -d '{"address":"cosmos1.."}'  localhost:9090 witvalchain.group.v1.Query/ProposalsByGroupPolicy
```
...
```bash
witvalchain.group.v1.Query/VoteByProposalVoter
```
...
```bash
grpcurl -plaintext \
    -d '{"proposal_id":"1","voter":"cosmos1.."}'  localhost:9090 witvalchain.group.v1.Query/VoteByProposalVoter
```
...
```bash
witvalchain.group.v1.Query/VotesByProposal
```
...
```bash
grpcurl -plaintext \
    -d '{"proposal_id":"1"}'  localhost:9090 witvalchain.group.v1.Query/VotesByProposal
```
...
```bash
witvalchain.group.v1.Query/VotesByVoter
```
...
```bash
grpcurl -plaintext \
    -d '{"voter":"cosmos1.."}'  localhost:9090 witvalchain.group.v1.Query/VotesByVoter
```
